...
<html>
    ...
    <div class="pt-16 max-w-screen-xl" style="min-width: 1280px">
        <div class="flex flex-col items-center">
            <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Show Message</h1>
            <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Message's information.</p>
        </div>

        <div class="flex justify-center rounded-md mb-4" role="group">
            <g:link action="edit" resource="${this.message}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-900 rounded-s-lg hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700">
        ...
        <dl class="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700 mb-4">
            ...
            <div class="flex flex-col py-3">
                <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Post</dt>
                <dd class="text-lg font-semibold">
                    <g:fieldValue bean="${message}" field="post.title"/>
                </dd>
            </div>
        </dl>
