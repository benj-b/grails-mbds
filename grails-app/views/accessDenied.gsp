...
<div class="flex flex-col justify-center items-center h-[calc(100%-1rem)]">
		<h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">403 <span class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Forbidden</span></h1>
		<p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Sorry but you don't have permission to access this page.</p>
